...
sub CountNodeJS($$$$) {
    ...
    CloudReady::detection::addFileDetection($fichier, CloudReady::Ident::Alias_CloudActiveDirectory(), checkDependencyAndPattern($code, $HString, CloudReady::Ident::Alias_CloudActiveDirectory, "(?:adal(?:[\.\-].*)?|activedirectory|react\-adal)", qr/\bnew AdalConfig\b/, undef, $text));
