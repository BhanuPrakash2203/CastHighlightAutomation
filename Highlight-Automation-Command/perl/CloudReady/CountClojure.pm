...
sub CountClojure($$$) {
	...
	CloudReady::detection::addFileDetection($fichier, CloudReady::Ident::Alias_DBMS_DynamoDB(), checkUseAndString(qr/\b(?:portkey\.aws\.dynamodb|amazonica\.aws\.dynamodbv2|com\.amazonaws\.services\.dynamodbv2|com\.amazonaws\.services\.dynamodbv2)\b/, qr/\b(?:dynamodb)\b/, $code, $text, $HString, CloudReady::Ident::Alias_DBMS_DynamoDB));
