...
sub CountJava($$$) {
	...
	CloudReady::detection::addFileDetection($fichier, CloudReady::Ident::Alias_Import_Jetty(), $checkPattern->(qr/\bimport\s+jetty\./, $code, CloudReady::Ident::Alias_Import_Jetty));
