...
our @EXPORT = qw(	Java JSP JavaScript PHP C_Cpp Objective_C Matlab CSharp KornShell VB_DotNet Nsdk PlSql TSql PL1 Cobol Abap JS_EMBEDDED Apex Sybase MySQL PostgreSQL DB2
...
# technos discovered but not yet analyzed
